...
var AuthService = function () {
    ...
    var AuthService = _classThis = /** @class */ (function () {
        ...
        AuthService_1.prototype.findAll = function () {
            return "This action returns all auth";
        };
        AuthService_1.prototype.findOne = function (id) {
            return "This action returns a #".concat(id, " auth");
        };
        AuthService_1.prototype.update = function (id, updateAuthDto) {
            return "This action updates a #".concat(id, " auth");
        };
        AuthService_1.prototype.remove = function (id) {
            return "This action removes a #".concat(id, " auth");
        };
